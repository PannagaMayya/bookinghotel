...
function HotelPage() {
  ...
  let dataToDisplay = () =>
    error
      ? hotelData.data.hotellist.filter((e) =>
          e.taggedCity
            .toLowerCase()
            .includes(location?.state?.destination?.toLowerCase() || "")
        )
      : data;
  return (
    <div
    ...
    >
      ...
      <div className="d-none m-3 d-lg-block p-3 align-self-start bg-warning rounded sticky_style_search">
        <SearchBarHotel
          searchState={location?.state}
          handleLocation={handleLocation}
        />
      ...
      <div className="flex-fill flex-column">
        {loading ? (
          ...
          <div className="border border-danger rounded m-4 p-5">
